...
\begin{align*}
I(\xi)&=\int_0^{2\pi}\int_0^\xi d\sigma\,\sin\theta\,d\theta\,d\phi
\\
&=2\pi\int_0^\xi d\sigma\,\sin\theta\,d\theta
\end{align*}
...
=\frac{2\pi}{C}\left(\frac{d\sigma}{d\Omega}\right)\sin\theta,
\qquad0\le\theta\le\pi
\end{equation*}
