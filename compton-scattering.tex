...
(The following plot is for $\omega=5\,\text{MeV}$)
...
\noindent
The following table shows the angular distribution for $\omega=5\,\text{MeV}$ and four bins.
...
\hline
$0^\circ$ & $45^\circ$ & 0.52 \\
$45^\circ$ & $90^\circ$ & 0.29 \\
$90^\circ$ & $135^\circ$ & 0.14 \\
$135^\circ$ & $180^\circ$ & 0.05 \\
\hline
\end{tabular}
\end{center}
