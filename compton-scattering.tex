...
\noindent
Compton scattering occurs from the interaction of photons and electrons.
In typical Compton scattering experiments the electron is at rest.
...
The following diagram shows a photon and an electron scattering through angle $\theta$
...
\noindent
The probability of observing scattering between $\theta_1$ and $\theta_2$ is
\begin{equation*}
