...
\begin{equation*}
\frac{d\sigma}{d\Omega}=\frac{1}{64\pi^2\epsilon_0^2m^2c^4}
...
=\frac{e^4}{32\pi^2\epsilon_0^2m^2c^4}
...
where
\begin{equation*}
\frac{e^4}{32\pi^2\epsilon_0^2m^2c^4}=3.97\times10^{-30}\,\text{meter}^2
\end{equation*}
...
to obtain
\begin{equation*}
\frac{d\sigma}{d\Omega}=\frac{\hbar^2\alpha^2}{2m^2c^2}\left(1+\cos^2\theta\right)
\end{equation*}
