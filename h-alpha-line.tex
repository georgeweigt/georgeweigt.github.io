...
\noindent
For each H-$\alpha$ transition, an average $A_{ki}$ is obtained by summing $A_{ki}$ for individual processes
...
\bigskip
\noindent
$A_{ki}$ can be computed using the following Heisenberg formula.
\begin{equation*}
...
\bigskip
\noindent
Some of the $|r_{ki}|^2$ are zero meaning those processes are forbidden.

\bigskip
\noindent
The following tables show $|r_{ki}|^2$ for each process (multiply all by $a_0^2$).
