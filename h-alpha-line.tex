...
\begin{center}
\includegraphics[scale=0.3]{balmer-alpha-line.png}
\end{center}
...
\noindent
Let us compute $A_{ki}$ for the H-$\alpha$ line and see if the results match the table.

\bigskip
\noindent
The orbitals correspond to the following angular momenta.
...
\\
\psi_{3,1,-1}&\rightarrow\psi_{2,0,-1}
\end{align*}
