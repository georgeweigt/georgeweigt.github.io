...
Use (2) and (3) to obtains the following equations of motion.
\begin{equation*}
\ddot Q_\alpha^c=-\omega_\alpha^2Q_\alpha^c
\qquad
\ddot Q_\alpha^s=-\omega_\alpha^2Q_\alpha^s
\tag{4}
\end{equation*}

From (8.7), let $\phi_0$ be the ground state wave function associated with (4).
\begin{equation*}
