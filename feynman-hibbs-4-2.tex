...
\INT\exp\left(\frac{im}{2\hbar\epsilon}\boldsymbol\eta^2\right)
\frac{1}{2}
\left(\frac{ie}{\hbar c}\boldsymbol\eta\cdot\mathbf A(\mathbf x,t)\right)^2
(\boldsymbol\eta\cdot\nabla\psi)
\,d\eta_1\,d\eta_2\,d\eta_3
\\&
{}=\INT\exp\left(\frac{im}{2\hbar\epsilon}\boldsymbol\eta^2\right)
...
%\left(\frac{2\pi i\hbar\epsilon}{m}\right)^2
%\left(
%\frac{1}{2}\mathbf A\cdot\mathbf A\nabla^2\psi+\mathbf A\cdot\nabla\nabla\psi\mathbf A
%\right)

Substitute the solved integrals into (6).
\begin{equation*}
\psi(\mathbf x,t)+\epsilon\frac{\partial\psi}{\partial t}
=\frac{1}{A}
\left(1-\frac{ie\epsilon}{\hbar}\phi\left(\mathbf x,t\right)\right) I
\end{equation*}
where
\begin{align*}
...
Rewrite $I$ in terms of operators.
