...
The following diagram shows the geometry of a collider experiment
for obtaining Moller scattering data.
\begin{center}
\begin{tikzpicture}
...
\noindent
It can be shown that this monster reduces to the following simple form.
\begin{equation*}
