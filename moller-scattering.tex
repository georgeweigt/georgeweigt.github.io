...
\begin{align*}
I(\xi)&=\frac{4E^2}{\alpha^2}\int_0^{2\pi}\int_a^\xi d\sigma
\\
&=2\pi\int_a^\xi\frac{(3+\cos^2\theta)^2}{\sin^4\theta}\,\sin\theta\,d\theta
\\
&=2\pi\left(-\cos\theta-\frac{8\cos\theta}{\sin^2\theta}\right)\bigg|_a^\xi
\\
&=2\pi\left(\cos a+\frac{8\cos a}{\sin^2 a}-\cos\xi-\frac{8\cos\xi}{\sin^2\xi}\right),
\qquad a\le\xi\le\pi-a
\end{align*}

\noindent
Support is limited to $a>0$ because $I(0)$ and $I(\pi)$ are undefined.
