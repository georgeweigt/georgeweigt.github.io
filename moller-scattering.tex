...
\begin{align*}
p_1&=
\underset{\substack{\phantom{0}\\ \text{electron 1}}}
{\begin{pmatrix}E\\0\\0\\p\end{pmatrix}}
&
p_2&=
\underset{\substack{\phantom{0}\\ \text{electron 2}}}
{\begin{pmatrix}E\\0\\0\\-p\end{pmatrix}}
&
p_3&=
\underset{\substack{\phantom{0}\\ \text{electron 3}}}
{\begin{pmatrix}
E\\
p\sin\theta\cos\phi\\
p\sin\theta\sin\phi\\
...
&
p_4&=
\underset{\substack{\phantom{0}\\ \text{electron 4}}}
{\begin{pmatrix}
E\\
-p\sin\theta\cos\phi\\
-p\sin\theta\sin\phi\\
...
\begin{align*}
u_{11}&=
\underset{\substack{\phantom{0}\\ \text{electron 1}\\ \text{spin up}}}
{\begin{pmatrix}E+m\\0\\p\\0\end{pmatrix}}
&
u_{12}&=
\underset{\substack{\phantom{0}\\ \text{electron 1}\\ \text{spin down}}}
{\begin{pmatrix}0\\E+m\\0\\-p\end{pmatrix}}
&
u_{21}&=
\underset{\substack{\phantom{0}\\ \text{electron 2}\\ \text{spin up}}}
{\begin{pmatrix}E+m\\0\\-p\\0\end{pmatrix}}
&
u_{22}&=
\underset{\substack{\phantom{0}\\ \text{electron 2}\\ \text{spin down}}}
{\begin{pmatrix}0\\E+m\\0\\p\end{pmatrix}}
\\[2ex]
u_{31}&=
\underset{\substack{\phantom{0}\\ \text{electron 3}\\ \text{spin up}}}
{\begin{pmatrix}E+m\\0\\p_{3z}\\p_{3x}+ip_{3y}\end{pmatrix}}
&
u_{32}&=
\underset{\substack{\phantom{0}\\ \text{electron 3}\\ \text{spin down}}}
{\begin{pmatrix}0\\E+m\\p_{3x}-ip_{3y}\\-p_{3z}\end{pmatrix}}
&
u_{41}&=
\underset{\substack{\phantom{0}\\ \text{electron 4}\\ \text{spin up}}}
{\begin{pmatrix}E+m\\0\\p_{4z}\\p_{4x}+ip_{4y}\end{pmatrix}}
&
u_{42}&=
\underset{\substack{\phantom{0}\\ \text{electron 4}\\ \text{spin down}}}
{\begin{pmatrix}0\\E+m\\p_{4x}-ip_{4y}\\-p_{4z}\end{pmatrix}}
\end{align*}

The second digit in spinor subscripts is 1 for spin up and 2 for spin down.
...
\frac{\left(\cos^2\theta+3\right)^2}{\sin^3\theta}\,d\theta\,d\phi
\end{equation*}

\noindent
Let $I(\theta)$ be the following integral of $d\sigma$.
\begin{equation*}
I(\theta)=\int\frac{\left(\cos^2\theta+3\right)^2}{\sin^3\theta}\,d\theta
...
\begin{equation*}
F(\theta)=\frac{I(\theta)-I(a)}{I(\pi)-I(a)},\quad a\le\theta\le\pi-a
\end{equation*}
