...
\noindent
It can be shown that this monster reduces to the following compact form.
\begin{equation*}
\langle|\mathcal{M}|^2\rangle
=4e^4\frac{\left(3+\cos^2\theta\right)^2}{\sin^4\theta}
\end{equation*}
...
=\frac{e^4}{64\pi^2E^2}\,\frac{\left(3+\cos^2\theta\right)^2}{\sin^4\theta}
\end{equation*}

\noindent
Substituting $e^2=4\pi\alpha$ yields
\begin{equation*}
\frac{d\sigma}{d\Omega}=\frac{\alpha^2}{4E^2}\,\frac{\left(3+\cos^2\theta\right)^2}{\sin^4\theta}
\end{equation*}
...
Hence
\begin{equation*}
d\sigma=\frac{\alpha^2}{4E^2}\,\frac{\left(3+\cos^2\theta\right)^2}{\sin^4\theta}\,\sin\theta\,d\theta\,d\phi
\end{equation*}
...
\\
&=\int_a^\xi\frac{\left(3+\cos^2\theta\right)^2}{\sin^4\theta}\,\sin\theta\,d\theta
\\
...
=C^{-1}\frac{\left(3+\cos^2\theta\right)^2}{\sin^3\theta}
\end{equation*}
