...
\frac{(\cos^2\theta+3)^2}{\sin^3\theta}\,d\theta\,d\phi
\end{equation*}

\noindent
Let $I(\theta)$ be the integral of $d\sigma$.
\begin{align*}
I(\theta)&=\int_0^{2\pi}\int d\sigma
\\
&=\frac{2\pi\alpha^2}{s}
\int\frac{(\cos^2\theta+3)^2}{\sin^3\theta}\,d\theta
\\
&=\frac{2\pi\alpha^2}{s}\bigg(\frac{8\cos\theta}{\cos^2\theta-1}-\cos\theta\bigg),
