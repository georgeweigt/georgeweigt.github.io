...
Let $|\Psi\rangle$ be the following ``coherent'' state where $\bar n$ is the expected number of photons
...
\hat E=\hat E^\dag
\end{equation*}
This is important because Hermitian operators have real eigenvalues.
Hence we have confirmed that $\hat E$ corresponds to an observable quantity.
