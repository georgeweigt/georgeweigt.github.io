...
Hence
\begin{equation*}
\hat ac_n|n\rangle=c_n\sqrt{n}|n-1\rangle=\sqrt{\bar n}\exp(-i\omega t)c_{n-1}|n-1\rangle
\tag{3}
\end{equation*}

Noting that $\hat a|0\rangle=0$ we can write the summation index starting from 1.
\begin{equation*}
