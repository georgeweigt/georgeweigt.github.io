...
\begin{align*}
|0\rangle&=(1,0,0,0)\qquad\text{no electrons}\\
|1\rangle&=(0,1,0,0)\qquad\text{one electron in state $\phi_1$}\\
|2\rangle&=(0,0,1,0)\qquad\text{one electron in state $\phi_2$}\\
|3\rangle&=(0,0,0,1)\qquad\text{two electrons, one in state $\phi_1$, one in state $\phi_2$}
\end{align*}
