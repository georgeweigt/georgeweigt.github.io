...
For a system of two hydrogen atoms and an $\alpha$ particle the hamiltonian is
\begin{equation*}
...
The $V(\mathbf y+\mathbf a_1)$ in (3) shrinks as $\mathbf y$ grows
hence for $\mathbf y\ll\mathbf a_1$ we have the approximation
\begin{equation*}
\mathbf u\approx\frac{\mathbf a_1}{|\mathbf a_1|}
\end{equation*}

Hence the $\alpha$ particle trajectory is along the line $\mathbf a_1$.
