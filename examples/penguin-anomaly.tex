...
Excerpt from \textit{`Penguin' Anomaly Hints at Missing Particles}.\footnote{
Wolchover, Natalie.
\textit{`Penguin' Anomaly Hints at Missing Particles.}\\
...
Let us now find the combined probability of \textit{any} unlikely result,
...
mean $\mu=50$.
Then the probability of \textit{any} unlikely result after 100 tosses is
\begin{equation*}
