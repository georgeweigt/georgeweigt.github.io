...
From ``Quantum Mechanics'' by Susskind and Friedman, p.~350.

\bigskip
Verify the following spin operator table.
...
\href{https://georgeweigt.github.io/examples/spin-operator-table-demo.html}{Eigenmath script}
