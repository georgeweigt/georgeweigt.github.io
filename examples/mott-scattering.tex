...
Factor the $4m^2$ and substitute $v=p/m$ to obtain
\begin{equation*}
\frac{d\sigma}{d\Omega}
...
To restore $\hbar$ and $c$ to physical units,
change $\alpha$ to $\alpha\hbar c$ and
make the substitution
\begin{equation*}
v=\frac{p}{m}\rightarrow\frac{pc}{mc^2}=\frac{v}{c}=\beta
\end{equation*}

Hence
\begin{equation*}
\frac{d\sigma}{d\Omega}
=\left(\frac{Zm\alpha\hbar c}{2p^2\sin^2(\theta/2)}\right)^2
\left(1+\beta^2\cos^2(\theta/2)\right)
\end{equation*}
