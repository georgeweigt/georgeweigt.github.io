...
Mott scattering is relativistic Rutherford scattering.
...
Inbound wave functions ($V$ is volume).
\begin{align*}
...
Expected probability density $\langle|M|^2\rangle$.
\begin{equation*}
