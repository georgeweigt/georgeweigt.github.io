...
The following momentum vectors are for the center-of-mass frane with $E=\sqrt{p^2+m^2}$.
\begin{equation*}
...
\begin{align*}
\sum_{a,b}P_{11ab}&=\frac{e^4}{(t-m^2)^2}\operatorname{Tr}
\left[
(\slashed p_1+m)\gamma^\mu(\slashed q_1+m)\gamma^\nu(\slashed p_2-m)\gamma_\nu(\slashed q_1+m)\gamma_\mu
\right]
\\
\sum_{a,b}P_{12ab}&=\frac{e^4}{(t-m^2)(u-m^2)}\operatorname{Tr}
\left[
