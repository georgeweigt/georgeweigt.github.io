...
Imagine two machines $A$ and $B$ that measure spin.
...
Now suppose a third machine generates two spins in the following singlet state.
\begin{equation*}
...
Any theory that attempts to make $A$ and $B$ uncorrelated for the singlet state
(for example, a hidden variable theory)
