...
Each observer has an apparatus to measure a spin.
Each apparatus can be set in one of two orientations, 0 or 1.
For independent expectation values we have
\begin{equation*}
\langle A_j\rangle\langle B_k\rangle=\langle A_jB_k\rangle,\quad j,k\in\{0,1\}
\end{equation*}

Now consider all minimum and maximum expectation values along with a clever formula.
\begin{equation*}
\begin{matrix}
...
\begin{equation*}
\langle A_j\rangle\langle B_k\rangle\ne\langle A_jB_k\rangle
\tag{3}
\end{equation*}
