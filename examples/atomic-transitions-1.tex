...
Evaluate the inner product of $\psi_a$ and equation (1) to obtain
\begin{align*}
...
%%% Can't use Laplace transforms if H_1 is a function of t.

\bigskip
\href{https://georgeweigt.github.io/examples/atomic-transitions-1-demo.html}{Eigenmath script}
