...
% Quantum Tunneling of Particles through Potential Barriers at phys.libretexts.org

\section*{WKB method part 2}
...
\\[1ex]
-\frac{\hbar^2}{2m}\frac{d^2}{dx^2}&\psi_2+V_0\psi_2=E\psi_2 & 0&\le x\le L
\\[1ex]
-\frac{\hbar^2}{2m}\frac{d^2}{dx^2}&\psi_3=E\psi_3 & x&>L
\end{align*}
...
Use the WKB method to solve for $\psi_2$.
\begin{equation*}
\psi_2(x)=
...
Noting that
\begin{equation*}
\int\sqrt{\frac{2m(V_0-E)}{\hbar^2}}\,dx
=\sqrt{\frac{2m(V_0-E)}{\hbar^2}}\,x
\end{equation*}
...
Equivalently
\begin{equation*}
T=\left[1+\frac{V_0^2}{4E(V_0-E)}\sinh^2(\beta L)\right]^{-1}
\tag{9}
\end{equation*}

\href{https://georgeweigt.github.io/examples/wkb-method-part-2-demo.html}{Eigenmath script}
