...
We will derive eigenvalues for $L^2$ and $L_z$ from the following commutation relations.
\begin{align*}
[L_x,L_y]&=i\hbar L_z
\\
[L_y,L_z]&=i\hbar L_x
...
Start by defining the following ladder operators.
\begin{align*}
L_+&=L_x+iL_y
\\
L_-&=L_x-iL_y
...
From the ladder operators we have the commutation relations
\begin{align*}
...
Let $\mu_m$ be the maximum $\mu$ and
$\psi_m$ its eigenfunction such that
\begin{equation*}
...
Let $\mu_k$ be the minimum eigenvalue of $L_z$ and $\psi_k$ its eigenfunction such that
\begin{equation*}
...
\begin{equation*}
\lambda=(l\hbar)^2+l\hbar^2=l(l+1)\hbar^2
\end{equation*}

Hence $l(l+1)\hbar^2$ are eigenvalues for $L^2$.
\begin{equation*}
...
Hence $m\hbar$ are eigenvalues for $L_z$.
\begin{equation*}
