...
The $x_i$ are relative probabilities that are normalized by dividing by $\sum_ix_i$.
Predicted values $\hat y$ are computed by multiplying the total number of scattering events
times the probability per angle.
\begin{gather*}
\sum_ix_i=4529,\quad
\sum_iy_i=134295
\\
\hat y_i=\underset{\substack{\text{normalization}\\\text{constant}}}{\frac{1}{4529}}
\times
\underset{\substack{\text{relative}\\\text{probability}}}{x_i}
\times
