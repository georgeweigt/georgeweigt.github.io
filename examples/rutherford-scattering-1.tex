...
The scattering probability for angle $\theta_i$ is
\begin{equation*}
\Pr(\theta_i)=\frac{x_i}{\sum x}
\end{equation*}

Predicted values $\hat y_i$ are the product
$\Pr(\theta_i)$ times the total number of scattering events.
\begin{gather*}
\sum_ix_i=4529,\quad
\sum_iy_i=134295
\\
