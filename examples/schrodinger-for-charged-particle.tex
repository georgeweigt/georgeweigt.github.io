...
\frac{1}{2}\boldsymbol\eta\cdot\nabla(\boldsymbol\eta\cdot\nabla\psi)
=\frac{1}{2}\left(
\eta_x^2\frac{\partial^2\psi}{\partial x^2}
+\eta_y^2\frac{\partial^2\psi}{\partial y^2}
+\eta_z^2\frac{\partial^2\psi}{\partial z^2}
\right)
+\frac{1}{2}\left(
\eta_x\frac{\partial\psi}{\partial x}
+\eta_y\frac{\partial\psi}{\partial y}
+\eta_z\frac{\partial\psi}{\partial z}
\right)
\\
+\eta_x\eta_y\frac{\partial^2\psi}{\partial x\partial y}
+\eta_x\eta_z\frac{\partial^2\psi}{\partial x\partial z}
+\eta_y\eta_z\frac{\partial^2\psi}{\partial y\partial z}
\end{multline*}
...
I3 = 1/2 G2(a, b Ax) G0(a, b Ay) G0(a, b Az) d(psi(),x,x) +
     ...
     1/2 G1(a, b Ax) G0(a, b Ay) G0(a, b Az) d(psi(),x) +
     1/2 G0(a, b Ax) G1(a, b Ay) G0(a, b Az) d(psi(),y) +
     1/2 G0(a, b Ax) G0(a, b Ay) G1(a, b Az) d(psi(),z) +

     G1(a, b Ax) G1(a, b Ay) G0(a, b Az) d(psi(),x,y) +
     G1(a, b Ax) G0(a, b Ay) G1(a, b Az) d(psi(),x,z) +
     G0(a, b Ax) G1(a, b Ay) G1(a, b Az) d(psi(),y,z)
\end{verbatim}
