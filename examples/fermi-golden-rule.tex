...
Let the initial state be $\Psi(\mathbf r,0)=\psi_a(\mathbf r)$ hence the initial conditions are
\begin{equation*}
...
Transition density $P$ is squared magnitude of $c_b(t)$.
\begin{equation*}
...
where $E\pm\epsilon=\hbar(\omega_b-\omega_a)\pm\epsilon$
