...
Applying the Schrodinger equation we have
\begin{equation*}
...
=E_1c_1(t)\psi_1(x)\exp(-i\omega_1t)
+E_2c_2(t)\psi_2(x)\exp(-i\omega_2t)
\end{equation*}

Expand the time derivative.
\begin{multline*}
...
Substitute for $H_1(x)$ and $\Psi(x,t)$.
\begin{multline*}
i\hbar\frac{\partial c_1(t)}{\partial t}\psi_1(x)\exp(-i\omega_1t)
+i\hbar\frac{\partial c_2(t)}{\partial t}\psi_2(x)\exp(-i\omega_2t)
\\
