...
\begin{align*}
M_{21}&=\int\psi_2^*(\mathbf r)V(\mathbf r)\psi_1(\mathbf r)\,dx
\\
M_{22}&=\int\psi_2^*(\mathbf r)V(\mathbf r)\psi_2(\mathbf r)\,dx
\end{align*}
...
where $E=\hbar(\omega_2-\omega_1)$ and $\rho$ is density of states.
