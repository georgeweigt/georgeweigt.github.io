...
Find the transition rate $R_{1\rightarrow2}$ for the perturbing Hamiltonian
\begin{equation*}
...
\begin{equation*}
\Psi(\mathbf r,t)=c_1(t)\psi_1(\mathbf r)\exp(-i\omega_1t)+c_2(t)\psi_2(\mathbf r)\exp(-i\omega_2t)
\end{equation*}

We need to solve for $c_2(t)$ to find the transition rate $R_{1\rightarrow2}$.
...
=E_1c_1(t)\psi_1(\mathbf r)\exp(-i\omega_1t)
+E_2c_2(t)\psi_2(\mathbf r)\exp(-i\omega_2t)
\end{equation*}

Evaluate the time derivative.
\begin{multline*}
i\hbar\frac{\partial}{\partial t}\Psi(\mathbf r,t)
=i\hbar\frac{\partial c_1(t)}{\partial t}\psi_1(\mathbf r)\exp(-i\omega_1t)
+\boxed{\hbar\omega_1c_1(t)\psi_1(\mathbf r)\exp(-i\omega_1t)}
\\
{}+i\hbar\frac{\partial c_2(t)}{\partial t}\psi_2(\mathbf r)\exp(-i\omega_2t)
+\boxed{\hbar\omega_2c_2(t)\psi_2(\mathbf r)\exp(-i\omega_2t)}
\\
{}=H_0(\mathbf r)\Psi(\mathbf r,t)+H_1(\mathbf r,t)\Psi(\mathbf r,t)
\end{multline*}

Noting that $\hbar\omega_1=E_1$ and $\hbar\omega_2=E_2$,
the boxed terms cancel with $H_0(\mathbf r)\Psi(\mathbf r,t)$ leaving
\begin{equation*}
i\hbar\frac{\partial c_1(t)}{\partial t}\psi_1(\mathbf r)\exp(-i\omega_1t)
+i\hbar\frac{\partial c_2(t)}{\partial t}\psi_2(\mathbf r)\exp(-i\omega_2t)
...
\biggl[
c_1(t)\psi_1(\mathbf r)\exp(-i\omega_1t)+c_2(t)\psi_2(\mathbf r)\exp(-i\omega_2t)
\biggr]
\end{multline*}
...
\begin{align*}
M_{21}&=\int\psi_2^*(\mathbf r)V(\mathbf r)\psi_1(\mathbf r)\,d\mathbf r
\\
M_{22}&=\int\psi_2^*(\mathbf r)V(\mathbf r)\psi_2(\mathbf r)\,d\mathbf r
\end{align*}
...
=2\cos(\omega t+\phi)
\biggl[
c_1(t)M_{21}\exp[i(\omega_2-\omega_1)t]+c_2(t)M_{22}
\biggr]
\end{equation*}
...
For time $t$ near the origin use $c_1(t)\approx1$ and $c_2(t)\approx0$ to obtain
\begin{equation*}
i\hbar\frac{\partial c_2(t)}{\partial t}
=2\cos(\omega t+\phi)M_{21}\exp[i(\omega_2-\omega_1)t]
\end{equation*}

Solve for $c_2(t)$ by integrating.
\begin{equation*}
c_2(t)=\frac{2M_{21}}{i\hbar}
\int_0^t\cos(\omega t'+\phi)\exp[i(\omega_2-\omega_1)t']\,dt'
\end{equation*}

In exponential form
\begin{multline*}
c_2(t)=\frac{M_{21}}{i\hbar}
\int_0^t
\exp(i\omega t'+\phi)\exp[i(\omega_2-\omega_1)t']\,dt'
\\
{}+\frac{M_{21}}{i\hbar}
\int_0^t
\exp(-i\omega t'-\phi)\exp[i(\omega_2-\omega_1)t']\,dt'
...
=-\frac{M_{21}}{\hbar}
\,
\frac{\exp[i(\omega_2-\omega_1+\omega) t]-1}{\omega_2-\omega_1+\omega}
\,
\exp(i\phi)
\\{}-\frac{M_{21}}{\hbar}
\,
...
For $\omega$ such that $\omega\approx\omega_2-\omega_1$ the second term
...
we have
\begin{equation*}
c_2(t)=-\frac{2iM_{21}}{\hbar}
\,
\frac{
\sin\left[\frac{1}{2}(\omega_2-\omega_1-\omega)t\right]
\exp\left[\frac{1}{2}i(\omega_2-\omega_1-\omega)t\right]
...
\begin{equation*}
c_2(t)=-\frac{itM_{21}}{\hbar}
\,
\frac{
\sin\left[\frac{1}{2}(\omega_2-\omega_1-\omega)t\right]
\exp\left[\frac{1}{2}i(\omega_2-\omega_1-\omega)t\right]
}{\frac{1}{2}(\omega_2-\omega_1-\omega)t}
\,
\exp(-i\phi)
\end{equation*}
...
\begin{equation*}
c_2(t)=-\frac{itM_{21}}{\hbar}
\operatorname{sinc}\left[\frac{1}{2}(\omega_2-\omega_1-\omega)t\right]
\exp\left[\frac{1}{2}i(\omega_2-\omega_1-\omega)t\right]
\exp(-i\phi)
\tag{2}
\end{equation*}
...
\begin{equation*}
P=|c_2(t)|^2=\frac{t^2}{\hbar^2}\,|M_{21}|^2
\operatorname{sinc}^2\left[\frac{1}{2}(\omega_2-\omega_1-\omega)t\right]
\tag{3}
\end{equation*}
...
where $E\pm\epsilon=\hbar(\omega_2-\omega_1)\pm\epsilon$
and $\rho$ is density of states.
...
and obtained Fermi's golden rule (4).
...
we would have
\begin{equation*}
R_{1\rightarrow2}=\frac{2\pi}{\hbar}\left|\frac{M_{21}}{2}\right|^2\rho(\hbar\omega)
\end{equation*}
