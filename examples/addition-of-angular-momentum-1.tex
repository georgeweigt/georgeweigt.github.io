...
We have for orbital angular momentum $\mathbf L$
\begin{align*}
...
Let $\Psi$ be the product of wave function $\psi$ and spin vector $\chi$.
\begin{equation*}
\Psi=\psi\chi
\end{equation*}
...
Let $J^2$ be magnitude-squared of total angular momentum.
\begin{equation*}
