...
Griffith's book has a different approach.
...
\begin{align*}
\mathbf e_\theta&=\mathbf e_x\cos\theta\cos\phi
+\mathbf e_y\cos\theta\sin\phi
-\mathbf e_z\sin\theta
\\
\mathbf e_\phi&=-\mathbf e_x\sin\phi+\mathbf e_y\cos\phi
\end{align*}

to obtain
\begin{equation*}
\mathbf L=-i\hbar\left[
(-\mathbf e_x\sin\phi+\mathbf e_y\cos\phi)\frac{\partial}{\partial\theta}
-(\mathbf e_x\cos\theta\cos\phi+\mathbf e_y\cos\theta\sin\phi-\mathbf e_z\sin\theta)
...
In component form
\begin{align*}
L_x&=\mathbf L\cdot\mathbf e_x=i\hbar\left(\sin\phi\frac{\partial}{\partial\theta}
+\frac{\cos\theta\cos\phi}{\sin\theta}\frac{\partial}{\partial\phi}\right)
\\[1ex]
L_y&=\mathbf L\cdot\mathbf e_y=i\hbar\left(-\cos\phi\frac{\partial}{\partial\theta}
+\frac{\cos\theta\sin\phi}{\sin\theta}\frac{\partial}{\partial\phi}\right)
\\[1ex]
L_z&=\mathbf L\cdot\mathbf e_z=-i\hbar\frac{\partial}{\partial\phi}
\end{align*}
