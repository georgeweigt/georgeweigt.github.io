...
\frac{\sqrt{2m^3E_b}}{\hbar^3}\,d\Omega
=\left(\frac{l}{2\pi}\right)^3
\frac{mk}{\hbar^2}\,d\Omega
\end{equation*}
...
\begin{equation*}
\frac{mk}{\hbar^2}
=\frac{[\text{kg}]\,[\text{m}^{-1}]}{[\text{J}\,\text{s}]^2}
=\frac{1}{[\text{J}]\,[\text{m}^3]}
\end{equation*}

and
\begin{equation*}
R_{a\rightarrow b}=\frac{1}{[\text{J}\,\text{s}]}\,[\text{N}]^2\,[\text{m}]^5
\,\frac{1}{[\text{J}]\,[\text{m}^3]}=[\text{s}^{-1}]
\end{equation*}
