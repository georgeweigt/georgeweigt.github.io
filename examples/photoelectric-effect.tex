...
\begin{equation*}
\frac{k}{\alpha a\hbar c}
=\frac{[\text{m}^{-1}]}{[1]\,[\text{m}]\,[\text{J}\,\text{s}]\,[\text{m}\,\text{s}^{-1}]}
=\frac{1}{[\text{J}]\,[\text{m}^3]}
\end{equation*}

and
\begin{equation*}
R_{a\rightarrow b}=\frac{[\text{m}^{-1}]}{[\text{J}\,\text{s}]^2\,[\text{m}\,\text{s}^{-1}]}
\,[\text{N}]^2\,[\text{m}]^4
=[\text{s}^{-1}]
\tag{9}
\end{equation*}
