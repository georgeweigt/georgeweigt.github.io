...
we have
\begin{equation*}
|\langle\psi_b|H_1|\psi_a\rangle|^2=|H_{ba}|^2
\end{equation*}

where $H_{ba}$ is the transition amplitude
\begin{equation*}
H_{ba}=\frac{1}{2}\int\psi_b^*V(\mathbf r)\psi_a\,d\mathbf r
\end{equation*}
...
\href{https://georgeweigt.github.io/examples/photoelectric-effect-demo.html}{Eigenmath script}
