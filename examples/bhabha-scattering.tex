...
\begin{align*}
f_{11}&=32(p_1\cdot p_3)^2+32(p_1\cdot p_4)^2 & &=64E^4(\cos^2\theta+1)
\\
f_{12}&=-32(p_1\cdot p_4)^2 & &=-32E^4(\cos\theta+1)^2
\\
f_{22}&=32(p_1\cdot p_2)^2+32(p_1\cdot p_4)^2 & &=32E^4(\cos\theta+1)^2+128E^4
\end{align*}
