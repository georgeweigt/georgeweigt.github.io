...
where
\begin{equation*}
\mathcal M_{1abcd}=\underset{\text{annihilation}}
{\frac{e^2}{s}(\bar v_{1a}\gamma^\mu u_{2b})(\bar u_{4d}\gamma_\mu v_{3c})},
\quad
\mathcal M_{2abcd}=-\underset{\text{scattering}}
{\frac{e^2}{t}(\bar v_{1a}\gamma^\nu v_{3c})(\bar u_{4d}\gamma_\nu u_{2b})}
\end{equation*}
...
\begin{align*}
f_{11} &= 8 u^2 + 8 t^2 - 64 u m^2 - 64 t m^2 + 192 m^4
\\
f_{12} &= -8 u^2 + 64 u m^2 - 96 m^4
\\
f_{22} &= 8 u^2 + 8 s^2 - 64 u m^2 - 64 s m^2 + 192 m^4
\end{align*}

For $E\gg m$ a useful approximation is to set $m=0$ and obtain
\begin{align*}
f_{11}&=8u^2+8t^2 % 64E^4(\cos^2\theta+1)
\\
f_{12}&=-8u^2 % -32E^4(\cos\theta+1)^2
\\
f_{22}&=8u^2+8s^2 % 32E^4(\cos\theta+1)^2+128E^4
\end{align*}
...
\\
&=2e^4\left(\frac{u^2+t^2}{s^2}+\frac{2u^2}{st}+\frac{u^2+s^2}{t^2}\right)
\\
&=e^4\biggl(
