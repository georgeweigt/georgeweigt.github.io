...
In this section we will derive the eigenvalues of $L^2$ and $L_z$ from the commutators
\begin{align*}
[L_x,L_y]&=i\hbar L_z
\\
[L_y,L_z]&=i\hbar L_x
...
\href{https://georgeweigt.github.io/examples/angular-momentum-2-demo.html}{Eigenmath script}
