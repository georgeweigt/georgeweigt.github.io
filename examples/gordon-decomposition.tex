...
\begin{equation*}
\text{\ttfamily T}=\text{\ttfamily dot(gamma,transpose(gamma))}
\end{equation*}

Calculate $\sigma^{\mu\nu}$ (transpose to interchange $\mu$ and $\nu$ of $T^{\mu\alpha\nu}{}_\beta$).
\begin{equation*}
\text{\ttfamily sigmamunu}=\text{\ttfamily i/2 (T - transpose(T,1,3))}
\end{equation*}

Transpose $\sigma^{\mu\alpha\nu}{}_\beta$ to $\sigma^{\mu\alpha}{}_\beta{}^\nu$.
\begin{equation*}
\text{\ttfamily sigmamunu}=\text{\ttfamily transpose(sigmamunu,3,4)}
\end{equation*}
...
In Eigenmath code
\begin{equation*}
\text{\ttfamily dot(sigmamunu, gmunu, p2 - p1)}
\end{equation*}
