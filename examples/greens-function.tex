...
Recall that $\nabla^2=\nabla\cdot\nabla$ and for a scalar function
$f$ and a vector function $\mathbf F$ we have
\begin{equation*}
\nabla\cdot(f\mathbf F)
=\frac{\partial}{\partial x}(fF_x)+\frac{\partial}{\partial y}(fF_y)
+\frac{\partial}{\partial z}(fF_z)
=\nabla f\cdot\mathbf F+f\nabla\mathbf\cdot\mathbf F
\end{equation*}
