...
%\left|(\bar{u}_{3c}\gamma^\mu v_{4d})(\bar{v}_{2b}\gamma_\mu u_{1a})\right|^2
\end{equation*}
...
=\frac{(\alpha\hbar c)^2}{e^4}
\frac{\langle|\mathcal{M}|^2\rangle}{16E^2}
\end{equation*}

For high collision energies such that $E\gg M$ we use the following approximation of (1).
\begin{equation*}
