...
The expected probability $\langle|\mathcal M|^2\rangle$ is the average probability for all four spin states.
\begin{equation*}
...
where $s$ and $u$ are Mandelstam variables
\begin{equation*}
...
The solution is
\begin{equation*}
S(\theta_1,\theta_2)=\frac{\pi\alpha^2(\hbar c)^2}{s}\bigl(I(\theta_2)-I(\theta_1)\bigr)
\end{equation*}
