...
\begin{align*}
\sum_{ab}{\scriptsize\boxed1}&=\frac{e^4}{(s-m^2)^2}\operatorname{Tr}
\left[
(\slashed p_2+m)\gamma^\mu(\slashed q_1+m)\gamma^\nu(\slashed p_4+m)\gamma_\nu(\slashed q_1+m)\gamma_\mu
\right]
\\
\sum_{ab}{\scriptsize\boxed2}&=\frac{e^4}{(s-m^2)(u-m^2)}\operatorname{Tr}
\left[
(\slashed p_2+m)\gamma^\mu(\slashed q_2+m)\gamma^\nu(\slashed p_4+m)\gamma_\mu(\slashed q_1+m)\gamma_\nu
\right]
\\
\sum_{ab}{\scriptsize\boxed4}&=\frac{e^4}{(u-m^2)^2}\operatorname{Tr}
\left[
