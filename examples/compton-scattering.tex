...
\left(
\mathcal M_{1ba}\mathcal M_{1ba}^*
+\mathcal M_{1ba}\mathcal M_{2ba}^*+\mathcal M_{2ba}\mathcal M_{1ba}^*
+\mathcal M_{2ba}\mathcal M_{2ba}^*
\right)
\end{equation*}
