...
\draw[fill=black] (-2,-1.5) circle (0.5ex);
\draw[fill=black] (0,0) circle (0.5ex);
\draw[fill=black] (2,0.8) circle (0.5ex);
\end{tikzpicture}
\end{center}
...
Let $n_1$ and $n_2$ be the refractive indices
\begin{equation*}
n_1=\frac{c}{v_1},
\quad n_2=\frac{c}{v_2}
\end{equation*}

Multiply equation (1) by $c$ to obtain Snell's law
\begin{equation*}
n_1\sin\theta_1=n_2\sin\theta_2
\end{equation*}

\href{https://georgeweigt.github.io/examples/snells-law-demo.html}{Eigenmath script}
