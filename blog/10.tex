...
x_a\exp\left(-\frac{m\omega x_a^2}{2\hbar}-\frac{3i\omega t_a}{2}\right)
\end{equation*}
...
+\frac{im\omega x_b^2\cos(\omega T)}{2\hbar\sin(\omega T)}-\frac{3i\omega t_a}{2}
\right)
\end{multline*}

Substitute $t_b-T$ for $t_a$ and substitute $-\pi/(2\omega)$ for $T$.
The result is
\begin{equation*}
I=\psi_1(x_b,t_b)
\end{equation*}
