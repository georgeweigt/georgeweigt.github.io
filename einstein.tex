...
Let $N_{m\rightarrow n}$ be the number of atoms are molecules that change from energy level $E_m$ to $E_n$.
...
\bigskip
\noindent
At equilibrium, transition rates are equal.
\begin{equation*}
...
\noindent
We now consider the limit of $\RHO$ as $E_m-E_n\rightarrow\infty$.
\begin{equation*}
\lim_{E_m-E_n\rightarrow\infty}\RHO
