...
\begin{equation*}
\underset{\ABSORPTION}{\BNM\rho(\nu)p_n\exp\left(\frac{\varepsilon_m-\varepsilon_n}{kT}\right)}
=\underset{\INDUCED}{\BMN\rho(\nu)p_m}
...
\begin{equation*}
\underset{\ABSORPTION}{\BMN\rho(\nu)p_m\exp\left(\frac{\varepsilon_m-\varepsilon_n}{kT}\right)}
=\underset{\INDUCED}{\BMN\rho(\nu)p_m}
+\underset{\SPONTANEOUS}{\AMN p_m}
\end{equation*}
...
\begin{equation*}
\underset{\ABSORPTION}{\rho(\nu)\exp\left(\frac{\varepsilon_m-\varepsilon_n}{kT}\right)}
=\underset{\INDUCED}{\rho(\nu)}+\underset{\SPONTANEOUS}{\frac{\AMN}{\BMN}}
\end{equation*}
...
Factor out $\rho(\nu)$.
\begin{equation*}
\rho(\nu)\left(\exp\left(\frac{\varepsilon_m-\varepsilon_n}{kT}\right)-1\right)
=\frac{\AMN}{\BMN}
\end{equation*}
...
\noindent
We now consider the limit of $\rho(\nu)$ as $\varepsilon_m-\varepsilon_n\rightarrow\infty$.
\begin{equation*}
