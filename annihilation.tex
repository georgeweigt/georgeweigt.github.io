...
The differential cross section for annihilation is
\begin{equation*}
\frac{d\sigma}{d\Omega}=\frac{\langle|\mathcal{M}|^2\rangle}{256\pi^2E^2}
%=\frac{e^4}{128\pi^2E^2}\left(\frac{1+\cos\theta}{1-\cos\theta}+\frac{1-\cos\theta}{1+\cos\theta}\right),\quad E\gg m
\end{equation*}
...
=\frac{e^4}{128\pi^2E^2}\left(\frac{1+\cos\theta}{1-\cos\theta}+\frac{1-\cos\theta}{1+\cos\theta}\right)
\end{equation*}
