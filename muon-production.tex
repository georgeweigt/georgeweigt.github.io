...
\begin{equation*}
I(\theta)=\frac{\alpha^2}{16E^2}\int_0^{2\pi}\int\left(1+\cos^2\theta\right)\sin\theta\,d\theta\,d\phi
\end{equation*}
...
\bigg({-}\frac{\cos^3\theta}{3}-\cos\theta\bigg)
\end{equation*}
...
The probability of observing scattering between $\theta_1$ to $\theta_2$ is
\begin{equation*}
...
=2\pi\int_0^\pi\big(1+\cos^2\theta\big)\sin\theta\,d\theta
\end{equation*}
...
&=(2E)^2(2\pi)\frac{\alpha^2}{16E^2}\big(1+\cos^2\theta\big)\\
