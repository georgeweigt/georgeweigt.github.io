...
$$
\int_\Omega\big(1+\cos^2\theta\big)\,d\Omega
=\int_0^{2\pi}\int_0^\pi\big(1+\cos^2\theta\big)\sin\theta\,d\theta\,d\phi
...
\sigma
=\int_\Omega d\sigma
=\int_\Omega\frac{\alpha^2}{16E^2}\big(1+\cos^2\theta\big)\,d\Omega
...
Dividing by $I(\pi)$ normalizes the function so that $F(\pi)=1$.
Noting that
\begin{equation*}
\bigg({-}\frac{1}{3}\cos^3\xi-\cos\xi+\frac{4}{3}\bigg)\bigg|_{\xi=\pi}=\frac{8}{3}
\end{equation*}
we have
\begin{equation*}
F(\theta)=-\frac{1}{8}\cos^3\theta-\frac{3}{8}\cos\theta+\frac{1}{2},
\quad
0\le\theta\le\pi
\end{equation*}

\bigskip
We can now compute the probability of scattering between $\theta_1$ and $\theta_2$ as
\begin{equation*}
...
\begin{equation*}
f(\theta)=\frac{dF(\theta)}{d\theta}=\frac{3}{8}\big(1+\cos^2\theta\big)\sin\theta,
\quad0\le\theta\le\pi
\end{equation*}
