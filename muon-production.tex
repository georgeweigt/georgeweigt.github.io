...
\begin{equation*}
I(\theta)=\int_{\Omega} d\sigma
=\frac{\alpha^2}{16E^2}\int_0^{2\pi}\int\big(1+\cos^2\theta\big)\sin\theta\,d\theta\,d\phi
\end{equation*}
...
The probability of observing scattering in the interval
$\theta_1$ to $\theta_2$ is
\begin{equation*}
