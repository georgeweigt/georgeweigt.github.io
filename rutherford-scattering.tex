...
\draw[thick,->] (0.40,0.40) -- (1.3,1.3) node[anchor=south west] {$p_2,u_{2b}$};
\draw (1,0.5) node {$\theta$};
\end{tikzpicture}
\end{center}
...
\begin{equation*}
\langle|\mathcal{M}|^2\rangle=\frac{16\pi^2\alpha^2m^2Z^2}{p^4(\cos\theta-1)^2}
\end{equation*}
...
Hence
\begin{equation*}
\frac{d\sigma}{d\Omega}=\frac{\alpha^2m^2Z^2}{p^4(\cos\theta-1)^2}
\end{equation*}
...
Note that if we had carried through the $\alpha^2m^2Z^2/p^4$ in $I(\theta)$,
