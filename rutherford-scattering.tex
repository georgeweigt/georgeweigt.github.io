...
\begin{align*}
I(\xi)&=\frac{p^4}{2\pi m^2Z^2\alpha^2}\int_0^{2\pi}\int_a^\xi d\sigma
\\
&=\int_a^\xi\frac{1}{(\cos\theta-1)^2}\sin\theta\,d\theta
\\
&=\left(\frac{1}{\cos\theta-1}\right)\bigg|_a^\xi
\\
&=\frac{1}{\cos\xi-1}-\frac{1}{\cos a-1},\qquad a\le\xi\le\pi
\end{align*}
