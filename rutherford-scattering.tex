...
\bigskip
\noindent
The following formula computes a probability density $|\mathcal{M}(j,k)|^2$ for Rutherford scattering
where $j$ is the spin state of the inbound electron and $k$ is the spin state of the outbound electron.
\begin{equation*}
|\mathcal{M}(j,k)|^2=\frac{Z^2e^4}{q^4}\frac{1}{N}\left|\bar{u}_{2k}\gamma^0 u_{1j}\right|^2
\end{equation*}
