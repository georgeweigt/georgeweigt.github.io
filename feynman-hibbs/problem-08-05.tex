...
\begin{align*}
&\int_{-\infty}^\infty
\vert\Phi_0\vert^2\,dQ_1^c=\left(\frac{\pi\hbar}{\omega_1}\right)^{1/2}
\exp\left(\frac{\omega_1}{\hbar}(Q_1^c)^2\right)
\vert\Phi_0\vert^2
\tag{4}
\\
&\int_{-\infty}^\infty Q_1^c
\vert\Phi_0\vert^2\,dQ_1^c=0
\tag{5}
\\
...
Multiplying $\vert\Phi_0\vert^2$ by an exponential cancels a factor, i.e., in (1) and (4),
\begin{equation*}
