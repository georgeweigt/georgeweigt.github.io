...
\noindent
The following table shows the transition probability density for every possible transition.
\begin{center}
\begin{tabular}{rcccc}
...
For the allowed transitions, the transition probability density
