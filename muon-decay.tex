...
\noindent
Muon decay rate $\Gamma$ is an average over all possible values of momentum.
In the muon rest frame $p_1=(m_1,0,0,0)$ we have
\begin{equation*}
\Gamma=\frac{(2\pi)^4}{2m_1}
\int
\langle|\mathcal{M}|^2\rangle
\,\delta(p_1-p_2-p_3-p_4)
\,\frac{d^3p_2}{(2\pi)^32E_2}\,\frac{d^3p_3}{(2\pi)^32E_3}\,\frac{d^3p_4}{(2\pi)^32E_4}
\end{equation*}
...
\noindent
Converting from natural units to physical units yields
\begin{equation*}
\tau=\frac{96\pi^2h}{G_F^2\left(m_\mu c^2\right)^5}
\end{equation*}
