...
\noindent
And we will also use the following unnormalized Dirac spinors.
\begin{align*}
u_{11}&=\begin{pmatrix}E_1+m_\mu\\0\\p_{1z}\\p_{1x}+ip_{1y}\end{pmatrix}
&
...
\noindent
Symbols $E_n$ are total energy for particle $n$.
\begin{align*}
