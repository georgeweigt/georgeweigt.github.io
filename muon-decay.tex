...
\noindent
The following muon data table is from Particle Data Group.%\footnote{\tt https://pdg.lbl.gov/2020/listings/rpp2020-list-muon.pdf}
...
\noindent
Muon decay rate $\Gamma$ is essentially a weighted average of density $\langle|\mathcal{M}|^2\rangle$
over all possible values of particle momentum.
