...
\,\frac{d^3p_1}{E_1}\,\frac{d^3p_2}{E_2}\,\frac{d^3p_3}{E_3}\,\frac{d^3p_4}{E_4}
\end{equation*}

\noindent
In the muon rest frame $p_1=(m_1,0,0,0)$ this immediately simplifies to
\begin{equation*}
\Gamma=\frac{1}{m_1}
\int\int\int
\langle|\mathcal{M}|^2\rangle
...
\noindent
It can be shown that for the muon rest frame we have
\begin{equation*}
